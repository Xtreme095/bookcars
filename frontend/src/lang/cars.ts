...
const strings = new LocalizedStrings({
  ...
  hr: {
    NEW_CAR: 'Novi automobil',
    DELETE_CAR: 'Jeste li sigurni da želite obrisati ovaj automobil?',
    ...
    GEARBOX_MANUAL_SHORT: 'R',
    GEARBOX_AUTOMATIC_SHORT: 'A',
    FUEL_POLICY_LIKE_FOR_LIKE: 'Isti kao pri preuzimanju',
    FUEL_POLICY_FREE_TANK: 'Besplatno punjenje',
    FUEL_POLICY_FULL_TO_FULL: 'Puno na Puno',
    FUEL_POLICY_FULL_TO_EMPTY: 'Puno na Prazno',
    FUEL_POLICY_LIKE_FOR_LIKE_TOOLTIP: 'Ovaj automobil se isporučuje s gorivom i mora biti vraćen s istom količinom goriva.',
    FUEL_POLICY_FREE_TANK_TOOLTIP: 'Cijena uključuje puno spremnik goriva.',
    FUEL_POLICY_FULL_TO_FULL_TOOLTIP: 'Ovaj automobil se isporučuje s punim spremnikom goriva i mora biti vraćen s punim spremnikom goriva.',
    FUEL_POLICY_FULL_TO_EMPTY_TOOLTIP: 'Ovaj automobil se isporučuje s punim spremnikom goriva i mora biti vraćen s praznim spremnikom.',
    DIESEL_TOOLTIP: 'Ovaj automobil ima dizelski motor',
    GASOLINE_TOOLTIP: 'Ovaj automobil ima benzinski motor',
    ELECTRIC_TOOLTIP: 'Ovaj automobil je električni',
    HYBRID_TOOLTIP: 'Ovaj automobil je hibrid',
    PLUG_IN_HYBRID_TOOLTIP: 'Ovaj automobil je priključni hibrid',
    GEARBOX_MANUAL_TOOLTIP: 'Ovaj automobil ima ručni mjenjač',
    GEARBOX_AUTOMATIC_TOOLTIP: 'Ovaj automobil ima automatski mjenjač',
    SEATS_TOOLTIP_1: 'Ovaj automobil ima ',
    SEATS_TOOLTIP_2: 'sjedala',
    DOORS_TOOLTIP_1: 'Ovaj automobil ima ',
    DOORS_TOOLTIP_2: 'vrata',
    AIRCON_TOOLTIP: 'Ovaj automobil ima klimu',
    MILEAGE: 'Kilometraža',
    MILEAGE_UNIT: 'KM/dan',
    UNLIMITED: 'Neograničeno',
    LIMITED: 'Ograničeno',
    CANCELLATION: 'Otkazivanje',
    CANCELLATION_TOOLTIP: 'Rezervacija se može otkazati prije datuma početka najma.',
    AMENDMENTS: 'Izmjene',
    AMENDMENTS_TOOLTIP: 'Rezervacija se može izmijeniti prije datuma početka najma.',
    THEFT_PROTECTION: 'Zaštita od krađe',
    THEFT_PROTECTION_TOOLTIP: 'Najam može uključivati zaštitu od krađe.',
    COLLISION_DAMAGE_WAVER: 'Odricanje od naknade štete pri sudaru',
    COLLISION_DAMAGE_WAVER_TOOLTIP: 'Najam može uključivati odricanje od naknade štete pri sudaru.',
    FULL_INSURANCE: 'Potpuno osiguranje',
    FULL_INSURANCE_TOOLTIP: 'Najam može uključivati odricanje od naknade štete pri sudaru i zaštitu od krađe vozila.',
    ADDITIONAL_DRIVER: 'Dodatni vozač',
    INCLUDED: 'Uključeno',
    UNAVAILABLE: 'Nedostupno',
    CAR_AVAILABLE: 'Dostupno za najam',
    CAR_AVAILABLE_TOOLTIP: 'Ovaj automobil je dostupan za najam.',
    CAR_UNAVAILABLE: 'Nije dostupno za najam',
    CAR_UNAVAILABLE_TOOLTIP: 'Ovaj automobil nije dostupan za najam.',
    VIEW_CAR: 'Pogledaj ovaj automobil',
    EMPTY_LIST: 'Nema automobila.',
    ...
    LESS_THAN_VALUE_1: `Manje od ${PaymentService.currencyRTL() ? currency : ''}${depositFilterValue1}${!PaymentService.currencyRTL() ? (` ${currency}`) : ''}`,
    LESS_THAN_VALUE_2: `Manje od ${PaymentService.currencyRTL() ? currency : ''}${depositFilterValue2}${!PaymentService.currencyRTL() ? (` ${currency}`) : ''}`,
    LESS_THAN_VALUE_3: `Manje od ${PaymentService.currencyRTL() ? currency : ''}${depositFilterValue3}${!PaymentService.currencyRTL() ? (` ${currency}`) : ''}`,
    TRIPS: 'putovanja',
    CO2: 'CO2 utjecaj',
    FROM_YOU: ' od vas',
    TITLE_1: 'Auto ',
    TITLE_2: ' za vas',
    TITLE_CAR_AVAILABLE: 'automobil dostupan',
    TITLE_CARS_AVAILABLE: 'automobila dostupno',
    DETAILS: 'Detalji',
