...
const strings = new LocalizedStrings({
  fr: {
    ...
    PAY_AT_HOST: "Payer chez l'hôte lors de la prise en charge",
    PAY_AT_HOST_INFO: "Payez le montant total à l'hôte au moment de récupérer le véhicule.",
  ...
  en: {
    ...
    PAY_AT_HOST: "Pay at the host's location at pickup",
    PAY_AT_HOST_INFO: 'Pay the full amount to the host when you collect the car.',
  ...
  es: {
    ...
    PAY_AT_HOST: 'Pagar en la ubicación del anfitrión al recoger',
    PAY_AT_HOST_INFO: 'Pague el importe total al anfitrión al recoger el vehículo.',
