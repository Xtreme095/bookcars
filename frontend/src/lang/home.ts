...
const strings = new LocalizedStrings({
  ...
  hr: {
    ...
    DROP_OFF: 'Vrati na istu lokaciju',
    COVER: 'Rezervirajte svoj automobil danas!',
    SUPPLIERS_TITLE: 'Povezujemo vas s najvećim brendovima',
    MAP_TITLE: 'Karta lokacija za najam automobila',
    MAP_PICK_UP_SELECTED: 'Odabrana lokacija preuzimanja',
    MAP_DROP_OFF_SELECTED: 'Odabrana lokacija vraćanja',
    DESTINATIONS_TITLE: 'Pregledaj po odredištima',
    CAR_SIZE_TITLE: 'Upoznajte neke od naših veličina automobila',
    CAR_SIZE_TEXT: 'Naša vozila dolaze u tri glavne veličine.',
    MINI: 'MINI',
    MIDI: 'MIDI',
    MAXI: 'MAXI',
    SEARCH_FOR_CAR: 'Pretraži automobil',

    TITLE: 'Najbolje ponude za najam automobila',
    SUBTITLE: 'Usporedite naše cijene i rezervirajte svoj automobil danas!',
    WHY_TITLE: 'Rezervirajte kod nas danas i vozite s povjerenjem!',
    WHY_SERVICE_TITLE: 'Usluga',
    WHY_SERVICE: 'Pomoć na cesti 24 sata za vaš mir.',
    WHY_CHARGES_TITLE: 'Bez skrivenih troškova',
    WHY_CHARGES: 'Ono što vidite je ono što plaćate.',
    WHY_FLEET_TITLE: 'Prepoznatljiva flota',
    WHY_FLEET: 'Odaberite iz širokog izbora premium i pouzdanih vozila.',
    WHY_MILEAGE_TITLE: 'Neograničena kilometraža',
    WHY_MILEAGE: 'Istražite gradove i dalje bez ograničenja.',
    WHY_MILEAGE_ASTERISK: '*primjenjuje se kada je navedeno',
    SERVICES_TITLE: 'Što nas čini različitima?',
    SERVICES_FLEET_TITLE: 'Širok raspon vozila',
    SERVICES_FLEET: 'Od kompaktnih gradskih automobila do luksuznih SUV-ova, naša prepoznatljiva flota zadovoljava sve potrebe putovanja. Bilo da se radi o poslovnom ili slobodnom putovanju, imamo savršen automobil za vaše putovanje.',
    SERVICES_FLEXIBLE_TITLE: 'Fleksibilno preuzimanje i vraćanje',
    SERVICES_FLEXIBLE: 'Nudeći praktične lokacije i fleksibilno raspoređivanje, olakšavamo najam automobila. Bilo da stižete u grad ili na međunarodnu zračnu luku, vaše vozilo bit će spremno kada i vi.',
    SERVICES_PRICES_TITLE: 'Izvrsne cijene',
    SERVICES_PRICES: 'Nudimo konkurentne cijene na sva vozila, osiguravajući da dobijete vrhunske automobile po nepobjedivim cijenama. Nema potrebe za kompromisom - svaki put dobijete odličnu vrijednost za svoj novac.',
    SERVICES_BOOKING_ONLINE_TITLE: 'Jednostavna online rezervacija',
    SERVICES_BOOKING_ONLINE: 'Preskočite redove i rezervirajte svoj najam automobila u minutama putem naše jednostavne online platforme. Usporedite opcije, prilagodite svoj najam i osigurajte svoje vozilo bez napora.',
    SERVICE_INSTANT_BOOKING_TITLE: 'Trenutna rezervacija',
    SERVICE_INSTANT_BOOKING: 'Bez čekanja! Nakon što odaberete svoje vozilo i dovršite rezervaciju, primit ćete trenutnu potvrdu, osiguravajući glatku i jednostavnu proceduru najma.',
    SERVICES_SUPPORT_TITLE: 'Korisnička podrška 24/7',
    SERVICES_SUPPORT: 'Bilo da rezervirate vozilo, trebate pomoć na cesti ili imate bilo kakva pitanja, naš predani tim za podršku dostupan je 24 sata dnevno.',
    CUSTOMER_CARE_TITLE: `${env.WEBSITE_NAME} korisnička služba`,
    CONTACT_US: 'Kontaktirajte nas',
    CUSTOMER_CARE_SUBTITLE: 'Uvijek tu da pomognemo',
    CUSTOMER_CARE_TEXT: `U ${env.WEBSITE_NAME}, posvećeni smo pružanju brze i pouzdane podrške kako bismo osigurali da vaše iskustvo najma automobila bude glatko i ugodno od početka do kraja.`,
    CUSTOMER_CARE_ASSISTANCE: 'Pomoć na cesti 24/7',
    CUSTOMER_CARE_MODIFICATION: 'Upiti i izmjene',
    CUSTOMER_CARE_GUIDANCE: 'Smjernice za odabir vozila',
