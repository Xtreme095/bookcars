...
const strings = new LocalizedStrings({
  ...
  hr: {
    NEW_CAR: 'Novo vozilo',
    DELETE_CAR: 'Jeste li sigurni da želite izbrisati ovo vozilo?',
    CAR_CURRENCY: `${commonStrings.CURRENCY}/dan`,
    ...
    FUEL_POLICY_FREE_TANK: 'Pun spremnik uključen',
    FUEL_POLICY_FULL_TO_FULL: 'Puno/Puno',
    FUEL_POLICY_FULL_TO_EMPTY: 'Puno/Prazno',
    FUEL_POLICY_LIKE_FOR_LIKE_TOOLTIP: 'Vozilo se preuzima s gorivom u spremniku i mora se vratiti s istom količinom goriva.',
    FUEL_POLICY_FREE_TANK_TOOLTIP: 'Cijena uključuje pun spremnik goriva.',
    FUEL_POLICY_FULL_TO_FULL_TOOLTIP: 'Vozilo se preuzima s punim spremnikom goriva i mora se vratiti s punim spremnikom.',
    FUEL_POLICY_FULL_TO_EMPTY_TOOLTIP: 'Vozilo se preuzima s punim spremnikom goriva i može se vratiti s praznim spremnikom.',
    DIESEL_TOOLTIP: 'Ovo vozilo ima dizelski motor',
    GASOLINE_TOOLTIP: 'Ovo vozilo ima benzinski motor',
    ELECTRIC_TOOLTIP: 'Ovo vozilo je električno',
    HYBRID_TOOLTIP: 'Ovo vozilo je hibrid',
    PLUG_IN_HYBRID_TOOLTIP: 'Ovo vozilo je plug-in hibrid',
    GEARBOX_MANUAL_TOOLTIP: 'Ovo vozilo ima ručni mjenjač',
    GEARBOX_AUTOMATIC_TOOLTIP: 'Ovo vozilo ima automatski mjenjač',
    SEATS_TOOLTIP_1: 'Ovo vozilo ima ',
    SEATS_TOOLTIP_2: 'sjedala',
    DOORS_TOOLTIP_1: 'Ovo vozilo ima ',
    DOORS_TOOLTIP_2: 'vrata',
    AIRCON_TOOLTIP: 'Ovo vozilo ima klima uređaj',
    MILEAGE: 'Kilometraža',
    MILEAGE_UNIT: 'KM/dan',
    ...
    COLLISION_DAMAGE_WAVER: 'Pokriće štete od sudara',
    COLLISION_DAMAGE_WAVER_TOOLTIP: 'Najam može uključivati pokriće štete od sudara.',
    FULL_INSURANCE: 'Puno osiguranje',
    FULL_INSURANCE_TOOLTIP: 'Najam može uključivati pokriće štete od sudara i zaštitu od krađe vozila.',
    ADDITIONAL_DRIVER: 'Dodatni vozač',
    INCLUDED: 'Uključeno',
    AVAILABLE: 'Dostupno',
    UNAVAILABLE: 'Nedostupno',
    CAR_AVAILABLE: 'Prikazano u rezultatima pretrage',
    CAR_AVAILABLE_TOOLTIP: 'Ovo vozilo je prikazano u rezultatima pretrage.',
    CAR_UNAVAILABLE: 'Nije prikazano u rezultatima pretrage',
    CAR_UNAVAILABLE_TOOLTIP: 'Ovo vozilo nije prikazano u rezultatima pretrage.',
    VIEW_CAR: 'Pogledaj ovo vozilo',
    EMPTY_LIST: 'Nema vozila.',
    CANNOT_DELETE_CAR: 'Ovo vozilo se ne može izbrisati jer je povezano s rezervacijama. Možete ga, međutim, učiniti nedostupnim za najam tako da ga uredite.',
    GEARBOX: 'Mjenjač',
    ENGINE: 'Motor',
    DEPOSIT: 'Polog pri preuzimanju',
    LESS_THAN_VALUE_1: `Manje od ${isUS ? env.CURRENCY : ''}${env.DEPOSIT_FILTER_VALUE_1}${!isUS ? (` ${env.CURRENCY}`) : ''}`,
    LESS_THAN_VALUE_2: `Manje od ${isUS ? env.CURRENCY : ''}${env.DEPOSIT_FILTER_VALUE_2}${!isUS ? (` ${env.CURRENCY}`) : ''}`,
    LESS_THAN_VALUE_3: `Manje od ${isUS ? env.CURRENCY : ''}${env.DEPOSIT_FILTER_VALUE_3}${!isUS ? (` ${env.CURRENCY}`) : ''}`,
