...
const strings = new LocalizedStrings({
  ...
  hr: {
    GENERIC_ERROR: 'Došlo je do neočekivane pogreške.',
    CHANGE_LANGUAGE_ERROR: 'Došlo je do pogreške prilikom promjene jezika.',
    UPDATED: 'Izmjene su uspješno spremljene.',
    GO_TO_HOME: 'Idi na početnu stranicu',
    FULL_NAME: 'Ime i prezime',
    EMAIL: 'E-mail',
    PASSWORD: 'Lozinka',
    EMAIL_ALREADY_REGISTERED: 'Ova adresa e-pošte je već registrirana.',
    ...
    FIX_ERRORS: 'Molimo ispravite pogreške.',
    SEND_MESSAGE: 'Pošalji poruku',
    VERIFIED: 'Potvrđen račun',
    CAR: 'vozilo',
    CARS: 'vozila',
    RESEND_ACTIVATION_LINK: 'Ponovno pošalji poveznicu za aktivaciju računa',
    ACTIVATION_EMAIL_SENT: 'E-mail za aktivaciju je poslan.',
    EMAIL_NOT_VALID: 'Nevažeća adresa e-pošte',
    PHONE_NOT_VALID: 'Nevažeći broj telefona',
    BIRTH_DATE_NOT_VALID: `Vozač mora imati najmanje ${env.MINIMUM_AGE} godina.`,
    FORM_ERROR: 'Molimo ispravite pogreške.',
    ALL: 'Sve',
    SUPPLIER: 'Dobavljač',
    STATUS: 'Status',
    ...
    PAY_LATER: 'Odobri naknadno plaćanje',
    ANY: 'Bilo koji',
    NAME: 'Naziv',
    LONGITUDE: 'Zemljopisna dužina',
    LATITUDE: 'Zemljopisna širina',
    LICENSE_REQUIRED: 'Obavezna vozačka dozvola',
    LICENSE: 'Vozačka dozvola',
    MIN_RENTAL_DAYS: 'Minimalan broj dana najma',
    DRIVER_LICENSE: 'Vozačka dozvola',
    UPLOAD_DRIVER_LICENSE: 'Učitaj vozačku dozvolu...',
    PRICE_CHANGE_RATE: 'Stopa promjene cijene (+/- %)',
    SUPPLIER_CAR_LIMIT: 'Maks. broj vozila u pretrazi',
    NOTIFY_ADMIN_ON_NEW_CAR: 'Obavijesti administratora o novom vozilu',
    BLACKLISTED: 'Na crnoj listi',
    BLACKLISTED_TOOLTIP: 'Korisnici na crnoj listi više nemaju pristup platformi.',
    FIELD_NOT_VALID: 'Molimo poštujte traženi format',
  },
})
