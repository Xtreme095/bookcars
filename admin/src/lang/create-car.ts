...
const strings = new LocalizedStrings({
  ...
  hr: {
    NEW_CAR_HEADING: 'Novo vozilo',
    NAME: 'Naziv',
    LICENSE_PLATE: 'Registarska oznaka',
    LICENSE_PLATE_ALREADY_EXISTS: 'Ova registarska oznaka već postoji.',
    CAR_IMAGE_SIZE_ERROR: `Slika mora biti u formatu ${env.CAR_IMAGE_WIDTH}x${env.CAR_IMAGE_HEIGHT}`,
    RECOMMENDED_IMAGE_SIZE: `Preporučena veličina slike: ${env.CAR_IMAGE_WIDTH}x${env.CAR_IMAGE_HEIGHT}`,
    SUPPLIER: 'Dobavljač',
    LOCATIONS: 'Mjesta preuzimanja',
    AVAILABLE: 'Prikazano u rezultatima pretrage',
    CAR_TYPE: 'Motor',
    DAILY_PRICE: 'Cijena/dan',
    DISCOUNTED_DAILY_PRICE: 'Snižena cijena/dan',
    HOURLY_PRICE: 'Cijena/sat (1h)',
    DISCOUNTED_HOURLY_PRICE: 'Snižena cijena/sat (1h)',
    BI_WEEKLY_PRICE: 'Cijena/pola tjedna (3 dana)',
    DISCOUNTED_BI_WEEKLY_PRICE: 'Snižena cijena/pola tjedna',
    WEEKLY_PRICE: 'Cijena/tjedan',
    DISCOUNTED_WEEKLY_PRICE: 'Snižena cijena/tjedan',
    MONTHLY_PRICE: 'Cijena/mjesec',
    DISCOUNTED_MONThLY_PRICE: 'Snižena cijena/mjesec',
    SEATS: 'Sjedala',
    DOORS: 'Vrata',
    GEARBOX: 'Mjenjač',
    AIRCON: 'Klima uređaj',
    MINIMUM_AGE: 'Minimalna dob',
    MINIMUM_AGE_NOT_VALID: `Minimalna dob mora biti veća ili jednaka ${env.MINIMUM_AGE} godina.`,
    CAR_RANGE: 'Klasa',
    ...
    IS_DATE_BASED_PRICE: 'Cijene po datumima',
    DATE_BASED_PRICES: 'Cijene po datumima',
    BLOCK_ON_PAY: 'Blokiraj vozilo nakon uspješnog plaćanja',
  },
})
