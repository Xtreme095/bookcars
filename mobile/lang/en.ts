...
export const en = {
  ...
  VERIFICATION_SUBMITTED: 'Your documents have been submitted. We will review them shortly.',
  VERIFICATION_STATUS_PENDING: 'Your documents are being reviewed.',
  VERIFICATION_STATUS_APPROVED: 'Your identity is verified.',
  VERIFICATION_STATUS_REJECTED: 'Your verification was rejected for the following reason:',
  VERIFICATION_RESUBMIT_INFO: 'You can fix your documents and submit them again.',
  VERIFICATION_DOCUMENTS_REQUIRED: "Please upload your driver's license (front and back) and your ID document (front).",
