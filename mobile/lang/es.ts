...
export const es = {
  ...
  VERIFICATION_SUBMITTED: 'Sus documentos han sido enviados. Los revisaremos en breve.',
  VERIFICATION_STATUS_PENDING: 'Sus documentos están siendo revisados.',
  VERIFICATION_STATUS_APPROVED: 'Su identidad está verificada.',
  VERIFICATION_STATUS_REJECTED: 'Su verificación fue rechazada por el siguiente motivo:',
  VERIFICATION_RESUBMIT_INFO: 'Puede corregir sus documentos y enviarlos de nuevo.',
  VERIFICATION_DOCUMENTS_REQUIRED: 'Por favor, suba su licencia de conducir (anverso y reverso) y su documento de identidad (anverso).',
