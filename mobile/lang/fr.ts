...
export const fr = {
  ...
  VERIFICATION_SUBMITTED: 'Vos documents ont bien été soumis. Nous les examinerons rapidement.',
  VERIFICATION_STATUS_PENDING: 'Vos documents sont en cours de vérification.',
  VERIFICATION_STATUS_APPROVED: 'Votre identité est vérifiée.',
  VERIFICATION_STATUS_REJECTED: 'Votre vérification a été refusée pour la raison suivante :',
  VERIFICATION_RESUBMIT_INFO: 'Vous pouvez corriger vos documents et les soumettre à nouveau.',
  VERIFICATION_DOCUMENTS_REQUIRED: "Veuillez téléverser votre permis de conduire (recto et verso) et votre pièce d'identité (recto).",
